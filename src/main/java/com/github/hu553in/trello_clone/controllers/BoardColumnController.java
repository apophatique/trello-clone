...
public class BoardColumnController {
    ...
    public BoardColumnController(final BoardColumnService boardColumnService) {
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            headers = {@Header(name = "Location", description = "Board column URL", required = true)},
                            content = @Content
                    ),
    ...
    public ResponseEntity<?> create(
        ...
        return ResponseEntity.created(URI.create(
                "/api/board-columns/".concat(boardColumnService.create(createBoardColumnForm).toString())
        )).build();
    }
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Board column is not found", content = @Content),
                    @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content)
            }
    )
